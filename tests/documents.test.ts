...
describe("documents",()=>{
  ...
  it("uses editable contractor settings in the PDF contact block",()=>{const html=estimateHtml(fixture,{companyName:"Example Builders",contractorName:"Alex Smith",email:"alex@example.com",phone:"555-0100",addressLine1:"10 Oak Street",addressLine2:"Suite 4",city:"Pittsburgh",state:"PA",postalCode:"15222"});expect(html).toContain("Example Builders");expect(html).toContain("Alex Smith");expect(html).toContain("10 Oak Street · Suite 4 · Pittsburgh, PA 15222 · 555-0100 · alex@example.com")});
