...
import { catalogFormPayload } from "../src/ui/forms";
...
describe("estimate domain", () => {
  ...
  it("maps catalog form dollars to the strict cents API contract", () => expect(catalogFormPayload({ description: "2x4 stud", unit: "each", defaultPrice: "4.98" })).toEqual({ description: "2x4 stud", unit: "each", defaultPriceCents: 498, active: true, notes: null }));
});
