...
export function estimateHtml(s: EstimateSnapshot): string {
  ...
  const header = `<div class="page-header"><img src="${estimateHeader}" alt="Pro Angle Construction"><span class="brand-fix">CONSTRUCTION</span><div class="byline">Kevin Edinger &nbsp;|&nbsp; proangleconstruction@gmail.com</div></div>`;
